package com.akros.functional.springbootmvc;
...
import com.akros.functional.springbootmvc.ctrl.ProductController;
...
public class SpringBootMvcFnApplication {
	...
	RouterFunction<ServerResponse> allApplicationRoutes(ProductController pc, ProductService ps) {
		return route().add(pc.remainingProductRoutes(ps)).before(req -> {
