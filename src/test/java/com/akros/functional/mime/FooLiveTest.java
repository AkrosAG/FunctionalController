package com.akros.functional.mime;
...
@ComponentScan({ "com.akros.functional.mime" })
...
public class FooLiveTest {
	...
	private Response createAsResponse(final Foo resource) {
		...
		return RestAssured.given().contentType(marshaller.getMime()).body(resourceAsString).post(getURL());
	}
